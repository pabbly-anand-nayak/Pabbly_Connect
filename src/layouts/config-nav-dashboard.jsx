    ...
    items: [
      {
        ...
        children: [
          ...
          { title: 'Connections', path: paths.dashboard.group.inboxsettings },
          { title: 'Variables', path: paths.dashboard.group.userattributes },
          { title: 'Team Members', path: paths.dashboard.group.tags },
