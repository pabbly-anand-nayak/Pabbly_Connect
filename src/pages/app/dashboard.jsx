...
// import Box from '@mui/material/Box';
// import { useTheme } from '@mui/material/styles';
// import { Grid, Button, Tooltip, useMediaQuery } from '@mui/material';
...
// import { FolderSection } from 'src/sections/dashbaord/components/folder-section/folder-card-new';
// import TrashTableNew from 'src/sections/dashbaord/components/tables-section/table_trash/trash-table';
// import DashboardTable from 'src/sections/dashbaord/components/tables-section/table_dashbaord/dashbaord-table';
// import { CreateWorkflowDialog } from 'src/sections/dashbaord/components/table-option-components/create-workflow-dialog';
          ...
          <Grid item xs={12} md={8} lg={9}>
            <Box >
              ...
              <BigCard sx={{ mb: 4 }}
                ...
                buttonText="Create Workflow"
                buttonTooltip="Start building a new automation workflow."
                onButtonClick={handleConfigureWorkflow}
              />
            </Box>
