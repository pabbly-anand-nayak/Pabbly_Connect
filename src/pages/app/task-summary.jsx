...
import TaskSummaryTable from 'src/sections/settings/page-task-summary/Table-task-summary/table';
...
export default function Page() {
  ...
  return (
    <DashboardContent maxWidth="xl">
      ...
      >
        <PageHeader
        title="Task Summary" Subheading="View all of your task summaries. Any action being performed in your workflow is considered a task. Triggers are not calculated as tasks, and internal applications of Pabbly Connect, such as the filter, router, and formatter, are also not counted as tasks. Note that the task summary is only available for the last 30 days."
          link_added="#"
        />
