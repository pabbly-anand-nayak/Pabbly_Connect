...
const columnIndicesToShow = [0, 1, 3];
...
export function KanbanView() {
  ...
  // Filter columns based on the specific indices (1, 2, 4)
  const filteredColumns = board?.columns.filter((_, index) => columnIndicesToShow.includes(index));
