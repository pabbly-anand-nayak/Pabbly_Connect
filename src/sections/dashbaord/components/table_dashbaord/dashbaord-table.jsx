...
export default function DashboardTable({
  ...
  const noWorkflowCreated = tableData.length === 0; // When no tasks exist at all
        ...
        >
          <CardHeader
            title={
              <Box>
                <Box sx={{ typography: 'subtitle2', fontSize: '18px', fontWeight: 600 }}>
                  <Tooltip title={`Folder Name: ${selectedFolder}`} arrow placement="top">
                    {selectedFolder}
                  </Tooltip>
                </Box>
              </Box>
          ...
          <OrderTableToolbar
            ...
            dateError={dateError}
            numSelected={table.selected.length}
            noWorkflowCreated={noWorkflowCreated}
          />
          ...
          <Box sx={{ position: 'relative' }}>
            ...
            <Scrollbar >
              ...
              {noWorkflowCreated ? (
              <TableNoData
                  title="No Workfow Created!"
                  subTitle="No workflows available. Create a new workflow to get started!"
