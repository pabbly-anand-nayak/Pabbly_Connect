...
export function OrderTableRow({ row, selected, onViewRow, onSelectRow, onDeleteRow }) {
  ...
  const handleCloseDrawer2 = () => {
    setOpenDrawer2(false); // This will close the drawer
  };
  ...
  const handleRowClick = () => {
    handleOpenDrawer2(); // Open the drawer when row is clicked
  };
  ...
  const handleWorkflowNavigation = () => {
    console.log('Navigating to workflow'); // Check if this logs
  ...
  const renderPrimary = (
    ...
    >
          ...
          >
            {/* <Tooltip title={`Workflow Name: ${row.workflowName}`} placement="top" arrow>
              <Box
                ...
                onClick={paths.dashboard.workflow}
              >
                {row.workflowName}
              </Box>
            </Tooltip> */}
            ...
            <Tooltip title={`Workflow Name: ${row.workflowName}`} placement="top" arrow>
              <Box
                ...
                onClick={handleWorkflowNavigation} // Use the handler
              >
                {row.workflowName}
              </Box>
            </Tooltip>
      ...
      <TableCell width={200} align="right" onClick={(e) => e.stopPropagation()}>
        <Stack spacing={2} direction="row" alignItems="center">
          <Stack
            sx={{
              typography: 'body2',
