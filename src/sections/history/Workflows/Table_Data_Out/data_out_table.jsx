...
// import { DataInTableRow } from './data_out_row';
// import { DataoutTable } from './use-table-data-out';

// // ----------------------------------------------------------------------

// export default function DataOutTable({ sx, icon, title, total, color = 'warning', ...other }) {
//   const table = DataoutTable({ defaultOrderBy: 'orderNumber' });
...
export default function DataOutTable({
  searchQuery = '',
  sx,
  icon,
  title,
        ...
        {notFound ? (
          ...
          <Table size={table.dense ? 'small' : 'medium'}>
            <TableBody>
              ...
              />
              {!filteredData.length && !searchQuery && <TableNoData />}
            </TableBody>
          </Table>
        )}
      </Scrollbar>
