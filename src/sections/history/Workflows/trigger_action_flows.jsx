...
//       {/* <Box display="flex" justifyContent="flex-end" alignItems="center" width="100%" mt={3} gap={1}>
...
//           alignItems: { xs: 'flex-end', sm: 'center' }, // Right-align for mobile view
//           textAlign: { xs: 'right', sm: 'left' }, // Align text to the right for mobile
//         }}
//       >
//         <Tooltip title="Total Number of Paid Tasks Consumed" placement="top" arrow>
//           <Box display="flex" alignItems="center" gap={1}>
//             <Typography color="#637381">Paid Tasks Consumed</Typography>
//             <Label variant="soft" color="info" component="span">
//               1
//             </Label>
//           </Box>
//         </Tooltip>
...
//           gap={1}
//           sx={{
//             display: { xs: 'none', sm: 'flex' }, // Hide in mobile (xs), show in larger screens (sm and above)
//           }}
//         >
//           <Typography color="#637381">|</Typography>
//         </Box>
...
//           <Box display="flex" alignItems="center" gap={1}>
//             <Typography color="#637381">Free Tasks Consumed</Typography>
//             <Label variant="soft" color="success" component="span">
//               2
//             </Label>
//           </Box>
//         </Tooltip>
