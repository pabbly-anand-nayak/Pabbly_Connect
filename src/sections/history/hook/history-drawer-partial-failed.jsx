...
const ConfigurationDrawerPartialFailed = ({ open, onClose, publish, onChangePublish }) => {
            ...
            <Box sx={{ width: '100%' }}>
              ...
              <Box sx={{ display: 'auto' }}>
                <Box sx={{ gap: 1, alignItems: 'center', display: 'flex' }}>
                  ...
                  >
                    Task History ID - Partial-Failed IjU3NjYwNTZmMDYzNzA0MzA1MjZlNTUzNyI_3D_pc
                  </Typography>
                  <Tooltip
...
export { ConfigurationDrawerPartialFailed };
