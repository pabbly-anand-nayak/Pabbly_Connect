...
// import DateTime from 'src/components/custom-table/DateTime';
// import CustomTable from 'src/components/custom-table/custom-table';
// import { searchRows } from 'src/components/custom-table/searchUtils';
// import { usePopover, CustomPopover } from 'src/components/custom-popover';
...
//   //     id: 1,
//   //     sno: '1',
//   //     email: 'anand.nayak@pabbly.com',
//   //     workflows_folders_you_shared: 'Workflow 1',
//   //     date: 'Dec 18, 2024',
//   //   },
//   //   {
//   //     id: 2,
...
//   //     workflows_folders_you_shared: 'Workflow 2',
//   //     date: 'Dec 17, 2024',
//   //   },
//   // ];
...
//   // Updated filters state to handle both search and pagination
//   const [filters, setFilters] = useState({
//     state: {
//       name: '',
//       page: 0,
...
//   const searchableFields = ['email', 'workflows_folders_you_shared'];

//   // const filteredRows = searchRows(rows, filters.state.name, searchableFields);

//   // Updated filtering logic with memoized rows
...
//         ([key, value]) =>
//           ['email', 'workflows_folders_you_shared'].includes(key) &&
//           value?.toString().toLowerCase().includes(searchTerm)
//       )
//     );
//   }, [rows, filters.state.name]); // Now rows is memoized, so this is stable

//   // const handleSearch = (event) => {
//   //   setFilters((prev) => ({
//   //     ...prev,
//   //     state: { ...prev.state, name: event.target.value },
//   //   }));
//   // };
