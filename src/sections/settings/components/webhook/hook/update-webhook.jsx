...
//   useEffect(() => {
//     if (initialData) {
//       setWebhookName(initialData.webhookEvent || '');
...
// // export function UpdateWebhookDialog({ open, onClose, initialData }) {
// //   return <WebhookDialog open={open} onClose={onClose} initialData={initialData} mode="update" />;
// // }
...
export function UpdateWebhookDialog({
  title,
  content,
  action,
  open,
