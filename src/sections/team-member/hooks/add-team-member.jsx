...
//     setSelectedItems(newValue.filter((item) => item.type === 'item'));
//   };
...
//   const handleKeyPress = (event, option, selected) => {
...
//                   <li
//                     {...props}
//                     onClick={() => handleOptionClick(option, selected)}
//                     onKeyPress={(event) => handleKeyPress(event, option, selected)}
//                     role="checkbox"
//                     aria-checked={selected}
//                     tabIndex={0}
//                   >
//                     <Checkbox checked={selected} size="small" disableRipple />
//                     {option.name}
//                   </li>
//                 );
//               }}
